...
def run_training(train_loader,val_loader,load_path):
...
if __name__ == "__main__":
    ...
    checkpoint_path = "/Users/revanthgottuparthy/Desktop/DL/project2/checkpoints/model-epoch-1-losses-0.001.pth"
    run_training(train_dataloader,val_dataloader,checkpoint_path)
